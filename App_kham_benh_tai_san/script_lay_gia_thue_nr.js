...
(async () => {
    ...
    console.log("🚀 BẮT ĐẦU CRAWL GIÁ THUÊ NHÀ RIÊNG — 18 QUẬN HÀ NỘI");
    console.log("=".repeat(60));

    for (const [name, slug] of Object.entries(DISTRICTS)) {
        const url = `https://batdongsan.com.vn/cho-thue-nha-rieng-${slug}`;
        console.log(`\n📍 ${name} → ${url}`);
    ...
    link.download = "rental_yield_nha_rieng_ha_noi.csv";
    link.click();

    // Console summary
    console.log("\n" + "=".repeat(60));
    console.log("📊 BẢNG RENTAL YIELD — NHÀ RIÊNG HÀ NỘI T4/2026");
    console.log("=".repeat(60));
